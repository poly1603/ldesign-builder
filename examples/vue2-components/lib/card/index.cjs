...
require('./Card.vue.cjs');
var Card_vue_vue_type_script_lang = require('./Card.vue2.cjs');
...
Card_vue_vue_type_script_lang.default.install = function (Vue) {
  Vue.component(Card_vue_vue_type_script_lang.default.name || 'LCard', Card_vue_vue_type_script_lang.default);
};
...
exports.default = Card_vue_vue_type_script_lang.default;
exports.CARD_COMPONENT_NAME = CARD_COMPONENT_NAME;
