 ...
 */
import { ERROR_MESSAGES, ERROR_SUGGESTIONS } from '../constants/errors';
/**
 * 构建器错误类
 */
...
export class ErrorHandler {
     ...
     * 错误恢复机制
     */
    async recover(fn, fallback, maxRetries = 3) {
        let lastError = null;
 ...
 * 处理未捕获的异常
 */
export function setupGlobalErrorHandling(handler = errorHandler) {
    // 处理未捕获的异常
 ...
 * 判断是否为构建器错误
 */
export function isBuilderError(error) {
