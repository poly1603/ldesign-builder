 ...
 * 创建压缩处理器实例
 */
export function createMinifyProcessor(logger) {
    return new MinifyProcessor(logger);
}
/**
 * 获取默认压缩配置
 */
export function getDefaultMinifyConfig() {
    return {
        level: 'basic',
        js: {
            minifier: 'terser',
 ...
 * 检查是否需要压缩
 */
export function shouldMinify(config) {
...
//# sourceMappingURL=minify-processor.js.map