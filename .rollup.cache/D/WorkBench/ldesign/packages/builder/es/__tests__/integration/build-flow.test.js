...
describe('Build Flow Integration', () => {
    ...
    beforeEach(async () => {
        ...
        await fs.writeFile(join(tempDir, 'index.ts'), 'export const hello = (name: string) => `Hello, ${name}!`');
    ...
    describe('Basic Build Flow', () => {
        it('should complete build process', async () => {
            ...
            vi.spyOn(builder, 'bundlerAdapter').mockValue({
                name: 'rollup',
                version: '4.0.0',
                available: true,
...
//# sourceMappingURL=build-flow.test.js.map