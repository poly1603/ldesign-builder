...
describe('BuildPerformanceAnalyzer', () => {
    ...
    describe('Phase Management', () => {
        ...
        it('should handle multiple phases', () => {
            const phases = ['initialization', 'compilation', 'bundling'];
    ...
    describe('Performance Analysis', () => {
        ...
        it('should provide optimization recommendations', async () => {
            ...
            const hasMemoryRecommendation = analysis.recommendations.some(rec => rec.toLowerCase().includes('memory') || rec.includes('内存'));
...
//# sourceMappingURL=build-performance-analyzer.test.js.map