...
describe('BuildCacheManager', () => {
    ...
    describe('Cache Operations', () => {
        ...
        it('should delete cache entries', async () => {
            ...
            expect(mockFs.remove).toHaveBeenCalledWith(expect.stringContaining('.cache'));
        });
    ...
    describe('Cache Strategies', () => {
        it('should implement LRU strategy', async () => {
            ...
            mockFs.ensureDir.mockResolvedValue(undefined);
            mockFs.writeFile.mockResolvedValue(undefined);
            mockFs.readdir.mockResolvedValue(['key1.json', 'key2.json']);
    ...
    describe('Size Management', () => {
        it('should track cache size', async () => {
            mockFs.pathExists.mockResolvedValue(true);
            mockFs.readdir.mockResolvedValue(['file1.cache', 'file2.cache']);
            mockFs.stat.mockResolvedValue({ size: 1024, mtime: new Date() });
        ...
        it('should enforce max cache size', async () => {
            ...
            mockFs.stat.mockResolvedValue({ size: 800, mtime: new Date() });
    ...
    describe('Dependency Tracking', () => {
        it('should track file dependencies', async () => {
            ...
            expect(mockFs.writeFile).toHaveBeenCalledWith(expect.any(String), expect.stringContaining('dependent-key'), 'utf8');
        });
...
//# sourceMappingURL=build-cache-manager.test.js.map