 ...
 * @returns 构建器实例
 */
export function createBuilder(config, options = {}) {
    // 创建默认的日志记录器
 ...
 * @returns 构建器实例
 */
export function createDevBuilder(config, options = {}) {
    const devConfig = {
        input: 'src/index.ts',
        mode: 'development',
        minify: false,
 ...
 * @returns 构建器实例
 */
export function createProdBuilder(config, options = {}) {
    const prodConfig = {
        input: 'src/index.ts',
        mode: 'production',
        minify: true,
 ...
 * @returns 构建器实例
 */
export function createTypeScriptBuilder(config, options = {}) {
    const tsConfig = {
        input: 'src/index.ts',
 ...
 * @returns 构建器实例
 */
export function createVue3Builder(config, options = {}) {
    const vueConfig = {
        input: 'src/index.ts',
 ...
 * @returns 构建器实例
 */
export function createStyleBuilder(config, options = {}) {
    const styleConfig = {
        input: 'src/index.css',
 ...
 * @returns 构建器实例
 */
export function createQuickBuilder(input, output, options = {}) {
    const quickConfig = {
        input,
 ...
 * @returns 构建器实例
 */
export function createWatchBuilder(config, options = {}) {
    const watchConfig = {
        input: 'src/index.ts',
        watch: {
            include: ['src/**/*'],
 ...
 * @returns 构建器实例
 */
export async function createBuilderFromPackage(packageJsonPath = './package.json', options = {}) {
    try {
 ...
 * @returns 构建器实例数组
 */
export function createBuilders(configs, options = {}) {
 ...
 * @returns 构建器池
 */
export function createBuilderPool(configs, options = {}) {
