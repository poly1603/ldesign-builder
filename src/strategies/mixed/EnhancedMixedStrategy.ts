 ...
 * 增强混合策略
 */
export class EnhancedMixedStrategy implements BuildStrategy {
 ...
 * 创建增强混合策略
 */
export function createEnhancedMixedStrategy(config?: MixedFrameworkConfig): EnhancedMixedStrategy {
  return new EnhancedMixedStrategy(config)
}
